...
preprocessParams <- preProcess(data[,1:8], method=c("range"))
normData <- predict(preprocessParams, data[,1:8])
boxplot(data[1:5], names = names(data[1:5]), las = 2, col = c("#7E57C2","#42A5F5","#9CCC65","#EA80FC","#EC407A") ,horizontal = F)
```
<br>
<br>
...
```{r, echo=FALSE, }
boxplot(normData[1:5], names = names(normData[1:5]), las = 2, col = c("#7E57C2","#42A5F5","#9CCC65","#EA80FC","#EC407A") ,horizontal = F)
```
<br>
<br>
...
###Satisfaction Level
In this part, we want to found out relationship between Satisfaction Level and people who left job

####Left Job
In this part, we found out that those who left have low satisfaction level contain the most compare other satisfaction level.
